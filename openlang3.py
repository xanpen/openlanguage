...
def downloadDOC(savePath, doc_base_url):
    ...
    for row in soup_trs:
        ...
        full_dialogue += "\r\n" + sentence
    filetxt_dialogue = savePath + "/" + u"dialogue.txt"
    filehtml_vocabulary = savePath + "/" + u"vocabulary.html"
    filehtml_culture = savePath + "/" + u"culture.html"
